...
public class SysConfigServiceImpl implements ISysConfigService {
    ...
    public String selectConfigByKey(String configKey) {
        String configValue = Convert.toStr(ehcacheCache.getCacheObject(getCacheKey(configKey)));
        ...
        if (StringUtils.isNotNull(retConfig)) {
            ehcacheCache.setCacheObject(getCacheKey(configKey), retConfig.getConfigValue());
    ...
    public int insertConfig(SysConfig config) {
        ...
        if (row > 0) {
            ehcacheCache.setCacheObject(getCacheKey(config.getConfigKey()), config.getConfigValue());
        }
        return row;
    }
    ...
    public void clearConfigCache() {
        Collection<String> keys = ehcacheCache.keys(Constants.SYS_CONFIG_KEY + "*");
        ehcacheCache.deleteObject(keys);
    }
