...
public class SysConfigServiceImpl implements ISysConfigService {
    ...
    public String selectConfigByKey(String configKey) {
        String configValue = Convert.toStr(cacheCache.getCacheObject(getCacheKey(configKey)));
        ...
        if (StringUtils.isNotNull(retConfig)) {
            cacheCache.setCacheObject(getCacheKey(configKey), retConfig.getConfigValue());
    ...
    public void deleteConfigByIds(Long[] configIds) {
        for (Long configId : configIds) {
            ...
            cacheCache.deleteObject(getCacheKey(config.getConfigKey()));
        }
    }
    ...
    public void clearConfigCache() {
        Collection<String> keys = cacheCache.keys(Constants.SYS_CONFIG_KEY + "*");
        cacheCache.deleteObject(keys);
    }
