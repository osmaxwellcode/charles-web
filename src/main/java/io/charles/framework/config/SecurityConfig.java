...
import io.charles.framework.security.filter.JwtAuthenticationTokenFilter;
import io.charles.framework.security.handle.AuthenticationEntryPointImpl;
import io.charles.framework.security.handle.LogoutSuccessHandlerImpl;
    ...
    protected SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests((requests) -> {
                    ...
                    requests.requestMatchers("/login", "/register", "/captchaImage").anonymous()
                            .requestMatchers(
                                    HttpMethod.GET,
                                    "/",
                                    "/favicon.ico",
